...
impl EventState {
    ...
    pub fn propagation_is_stopped(&self) -> bool { self.propagation_stopped }
    pub fn redraw_is_requested(&self) -> bool { self.redraw_requested }
    pub fn merge(&self, other: &EventState) -> EventState {
        EventState { cancelled: self.cancelled | other.cancelled, propagation_stopped: self.propagation_stopped | other.propagation_stopped, redraw_requested: self.redraw_requested | other.redraw_requested }
    }
}
