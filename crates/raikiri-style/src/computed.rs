...
use crate::Atom;
use crate::property::{
    AlignSelfValue, BorderColor, BorderStyle, BoxSizing, ContentAlignmentValue, ContentComponent,
    CssColor, Direction, DisplayValue, FlexDirectionValue, FlexWrapValue, FontStyle, OverflowValue,
...
mod tests {
    ...
    ///
    /// field 単位で全 46 field を検査する — delegation は `finalize` を通るので、
