...
pub use resolve::{
    ...
    ComputedTabSize, ComputedTextDecorationInset, ComputedTextShadow, ComputedTransformFunction,
    ResolveContext, lift_border_spacing, lift_font_size, lift_length_or_normal,
    lift_length_percentage, lift_line_height, lift_tab_size, lift_text_shadow_item,
    ...
    resolve_font_size, resolve_grid_auto_track_list, resolve_grid_inflexible_breadth,
    resolve_grid_template_tracks, resolve_grid_track_breadth, resolve_grid_track_list,
    resolve_grid_track_size, resolve_length_or_normal, resolve_length_or_normal_with_ch,
