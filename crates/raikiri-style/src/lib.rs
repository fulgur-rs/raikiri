...
pub mod page;
pub use page::{
    PageCascadeResult, PageContextQuery, PageInheritance, PageOrientation, PagePseudo, PageRule,
    PageSelector, PageSelectorEntry, PageSize, PageSizeDeclaration, PageSizeKeyword, cascade_page,
};
...
pub use resolve::{
    ...
    ComputedLineHeight, ResolveContext, lift_font_size, lift_length_or_normal, lift_line_height,
    resolve_border, resolve_font_size, resolve_length_or_normal, resolve_length_percentage,
