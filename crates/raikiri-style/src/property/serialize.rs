...
pub fn serialize_value(value: &PropertyValue) -> Option<String> {
    match value {
        ...
        | PropertyValue::FontFamily(..)
        | PropertyValue::FontSizeRelative(..)
        ...
        | PropertyValue::CounterIncrement(..)
        | PropertyValue::CounterSet(..)
        ...
        | PropertyValue::BorderTopStyle(..)
        | PropertyValue::BorderRightStyle(..)
        | PropertyValue::BorderBottomStyle(..)
        | PropertyValue::BorderLeftStyle(..)
        | PropertyValue::BorderTopColor(..)
        | PropertyValue::BorderRightColor(..)
        ...
        | PropertyValue::TextDecorationColor(..)
        ...
        | PropertyValue::FlexShrink(..)
        | PropertyValue::FlexBasis(..)
        | PropertyValue::Flex(..)
        | PropertyValue::FlexFlow(..)
        | PropertyValue::Order(..)
        | PropertyValue::JustifyContent(..)
        | PropertyValue::AlignContent(..)
        | PropertyValue::AlignItems(..)
        | PropertyValue::AlignSelf(..)
        | PropertyValue::RowGap(..)
        ...
        | PropertyValue::Outline(..)
        | PropertyValue::OutlineStyle(..)
        | PropertyValue::OutlineColor(..)
        | PropertyValue::GridArea(..)
        | PropertyValue::Grid(..)
        | PropertyValue::GridTemplateColumns(..)
        | PropertyValue::GridTemplateRows(..)
        | PropertyValue::GridTemplateAreas(..)
        | PropertyValue::GridAutoColumns(..)
        | PropertyValue::GridAutoRows(..)
        | PropertyValue::GridAutoFlow(..)
        | PropertyValue::GridRowStart(..)
        | PropertyValue::GridRowEnd(..)
        | PropertyValue::GridColumnStart(..)
        | PropertyValue::GridColumnEnd(..)
        | PropertyValue::GridRow(..)
        | PropertyValue::GridColumn(..)
        | PropertyValue::JustifyItems(..)
        | PropertyValue::JustifySelf(..)
        | PropertyValue::PlaceItems(..)
        ...
        | PropertyValue::BackgroundClip(..)
        | PropertyValue::BackgroundOrigin(..)
        | PropertyValue::BackgroundSize(..)
