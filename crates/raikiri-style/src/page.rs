...
use crate::property::{
    Border, BorderColor, BorderRadius, BorderStyle, BoxShadowItem, FlexBasisValue, FlexShorthand,
    ...
    Outline, OverflowValue, OverflowXY, PropertyKey, PropertyValue, Sides, TextShadowItem,
...
mod tests {
    ...
    use crate::property::{
        ...
        Outline, OverflowValue, OverflowWrap, OverflowXY, PlaceContentShorthand,
        PlaceItemsShorthand, PlaceSelfShorthand, PositionValue, SelfAlignmentValue, TabSize,
        TextAlign, TextDecorationColor, TextDecorationLine, TextDecorationShorthand,
        TextDecorationStyle, TextShadowColor, TextTransform, VerticalAlign, Visibility, WhiteSpace,
        WordBreak, ZIndexValue,
    };
