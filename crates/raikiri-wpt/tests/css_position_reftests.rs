//! Focused CSS Position visual checks at the exact project viewport.
...
/// Absolute centering and fixed stacking cases match their references exactly.
#[test]
#[ignore = "requires the sparse WPT checkout from scripts/wpt/fetch.sh"]
fn position_pairs_are_pixel_exact_at_800x600() {
    ...
    for name in [
        ...
        let test = root.join("css/css-position").join(name);
