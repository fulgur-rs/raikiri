//! Focused CSS aspect-ratio visual checks.
...
fn intrinsic_aspect_ratio_is_pixel_exact_at_800x600() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../../target/wpt");
    let test = root.join("css/css-flexbox/aspect-ratio-intrinsic-size-007.html");
