...
/// Preserve collapsed source whitespace between sibling inline boxes at the
/// pinned exact 800x600 viewport.
#[test]
#[ignore = "requires the sparse WPT checkout from scripts/wpt/fetch.sh"]
fn inline_formatting_context_001_is_pixel_exact() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../../target/wpt");
    let test = root.join("css/CSS2/linebox/inline-formatting-context-001.xht");
    let pairs =
